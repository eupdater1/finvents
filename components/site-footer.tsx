    ...
    <footer className="border-t bg-secondary">
      <div className="mx-auto flex max-w-7xl flex-col gap-8 px-4 py-10 md:flex-row md:items-end md:justify-between md:px-6">
        <div className="flex max-w-md flex-col gap-2">
          <p className="font-semibold">Atlas Calendar</p>
      ...
      <div className="border-t px-4 py-4 text-center text-xs text-muted-foreground">© 2026 Atlas Calendar. Dates and figures are verified against primary sources.</div>
    </footer>
  )
}
