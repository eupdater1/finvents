...
const eventData: EventDetailData = {
  ...
  "description_short": "Release of Consumer Price Index data from FRED.",
  "description_long": "The Consumer Price Index release is a key macroeconomic indicator tracked for inflation, labor market, and growth analysis.",
  "impact_level": "medium",
  "impact_layer": {
...
export default function EventPage() {
  return <EventDetailPage data={eventData} slug="consumer-price-index-release" />
}
