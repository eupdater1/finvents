...
const eventData: EventDetailData = {
  ...
  "event_date_utc": "2026-01-01T00:00:00Z",
  "description_short": "Release of Gross Domestic Product data from FRED.",
  "description_long": "The Gross Domestic Product release is a key macroeconomic indicator tracked for inflation, labor market, and growth analysis.",
  "impact_level": "medium",
  "impact_layer": {
...
export default function EventPage() {
  return <EventDetailPage data={eventData} slug="gross-domestic-product-release" />
}
