...
const eventData: EventDetailData = {
  ...
  "event_date_utc": "2026-12-09T19:00:00Z",
  ...
  "historical_data_5yr": [],
  "related_events": [],
  "description_short": "The December FOMC meeting is the final policy decision of the year, setting the interest rate outlook for the economy heading into early 2027.",
...
export default function EventPage() {
  return <EventDetailPage data={eventData} slug="fomc-interest-rate-decision-fomc-meeting-2026-12" />
}
